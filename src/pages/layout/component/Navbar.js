        ...
        <nav
            ...
            <div className="navbar-nav-right d-flex align-items-center justify-content-end" id="navbar-collapse">
                ...
                <div className="nav-item d-flex align-items-center">
                    <span className="w-px-22 h-px-22"><i className="icon-base bx bx-search icon-md"></i></span>
                    <input type="text" className="form-control border-0 shadow-none ps-1 ps-sm-2 d-md-block d-none"
                ...
                <li className="nav-item navbar-dropdown dropdown-user dropdown">
                    <a className="nav-link dropdown-toggle hide-arrow p-0" href="javascript:void(0);" data-bs-toggle="dropdown">
                        <div className="avatar avatar-online">
                            ...
                            <img src= {`${process.env.PUBLIC_URL}/themeassets/assets/img/avatars/1.png`} alt="User Profile" className="w-px-40 h-auto rounded-circle" />
                        </div>
                    </a>
                    ...
                    <li>
                        ...
                        <span className="d-flex align-items-center align-middle">
                            <i className="flex-shrink-0 icon-base bx bx-credit-card icon-md me-3"></i><span
